...
This internship focuses on understanding the RISC-V ecosystem, FPGA-based IP development, computer architecture fundamentals, RTL design, simulation, verification, and hardware-software co-design concepts through a series of hands-on tasks and projects.
...
| Task 2 | SPIKE Simulation and Observation                                | 🔄 In Progress |
